...
@section('content')
    ...
    @push('scripts')
        ...
        <!-- Contoh jika hasil build tersimpan di public/build/assets -->
        <link rel="stylesheet" href="{{ asset('build/assets/app-CK5l9UVx.css') }}">
        <script src="{{ asset('build/assets/app-CaJXdLe6.js') }}" defer></script>
        <script src="{{ asset('js/chart-attendance.js') }}" defer></script>
        <script src="{{ asset('js/prayer-times.js') }}" defer></script>
    @endpush
@endsection
