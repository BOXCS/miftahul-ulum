...
@endpush
@section('content')
    @isset($edit)@dd($staff->toArray())@endisset
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 pe-md-5">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="jabatan" id="jabatan" class="form-control border border-black shadow-sm py-2">
                            </div>
                            <div class="mb-4">
                                <label for="tgl_bergabung" class="form-label fw-semibold text-black">Tanggal Bergabung</label>
                                <input type="date" name="tgl_bergabung" id="tgl_bergabung" class="form-control border border-black shadow-sm py-2">
                            </div>
                        </div>
