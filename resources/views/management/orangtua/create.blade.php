    ...
    <div class="container pt-3 pb-5">
        <div class="card shadow border-0 rounded-4">
            ...
            <div class="card-body px-5 py-4">
                <form action="{{ isset($orangtua) ? route('orangtua.update', $orangtua->id_ortu) : route('orangtua.store') }}" method="POST" enctype="multipart/form-data">
                    @if(isset($orangtua))
                        @method('PUT')
                    @endif
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 pe-md-5">
                            <div class="mb-4">
                                ...
                                <input type="text" name="nama_lengkap" id="nama_lengkap" class="form-control border border-black shadow-sm py-2" value="{{ isset($orangtua) ? $orangtua->nama_lengkap : '' }}" required>
                            </div>
                            <div class="mb-4">
                                <label for="alamat" class="form-label fw-semibold text-black">Alamat Lengkap</label>
                                <input type="text" name="alamat" id="alamat" class="form-control border border-black shadow-sm py-2" value="{{ isset($orangtua) ? $orangtua->alamat : '' }}" required>
                            </div>
                            <div class="mb-4">
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="email" name="email" id="email" class="form-control border border-black shadow-sm py-2" value="{{ isset($orangtua) ? $orangtua->akun->email : '' }}" required>
                            </div>
                            <div class="mb-4">
                                <label for="username" class="form-label fw-semibold text-black">Username</label>
                                <input type="text" name="username" id="username" class="form-control border border-black shadow-sm py-2" value="{{ isset($orangtua) ? $orangtua->akun->username : '' }}" required>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="radio" class="btn-check" name="hak_akses" id="ortu" autocomplete="off" value="ortu" {{ isset($orangtua)?($orangtua->akun->hak_akses=='ortu'?'checked':''):'checked' }}>
                                <label class="btn btn-outline-primary btn-radio" for="ortu">Orang tua</label>
                                <input type="radio" class="btn-check" name="hak_akses" id="admin" autocomplete="off" value="admin" {{ isset($orangtua)?($orangtua->akun->hak_akses=='admin'?'checked':''):'' }}>
                                <label class="btn btn-outline-info btn-radio" for="admin">Admin</label>
                                <input type="radio" class="btn-check" name="hak_akses" id="superadmin" autocomplete="off" value="superadmin" {{ isset($orangtua)?($orangtua->akun->hak_akses=='superadmin'?'checked':''):'' }}>
