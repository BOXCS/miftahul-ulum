...
<div style="margin-bottom:22px;">
    ...
    <h1 style="font-size:1.75rem;font-weight:800;color:#0f172a;letter-spacing:-.04em;line-height:1;">Tambah Wali Santri</h1>
    <p style="font-size:.85rem;color:#64748b;margin-top:4px;">Isi form di bawah untuk menambahkan data wali / orang tua santri baru</p>
</div>
...
<div class="form-card">
    ...
    <div class="form-card-header">
        ...
        <div>
            <div class="form-card-title">Data Wali Santri Baru</div>
    ...
    <div class="form-card-body">
        <form action="{{ route('parents.store') }}" method="POST" id="createForm">
            @csrf
            ...
            <div class="fg">
                ...
                <div class="fg fg-2">
                    <div>
                        ...
                        <select id="hubungan" name="relationship"
                            ...
                            <option value="{{ $option }}" {{ old('relationship') == $option ? 'selected' : '' }}>
                                {{ $option }}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="fg fg-2">
                    <div>
                        <label for="password" class="flabel">Password <span class="req">*</span></label>
                    ...
                    <div>
                        <label for="password_confirmation" class="flabel">Konfirmasi Password <span class="req">*</span></label>
    ...
    <div class="form-card-footer">
        ...
        <button type="submit" form="createForm" class="btn-teal">
