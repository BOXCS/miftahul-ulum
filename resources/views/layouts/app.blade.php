    ...
    <aside class="sidebar"
        ...
        <div class="sidebar-logo">
            <div class="flex items-center gap-3 min-w-0">
                ...
                <div class="flex-shrink-0 w-9 h-9 rounded-xl flex items-center justify-center shadow-lg"
        ...
        <div class="sidebar-footer">
            <div class="flex items-center gap-3 px-3 py-2 rounded-xl"
                ...
                <div class="nav-label flex flex-col min-w-0 flex-1">
                    <span class="text-white text-xs font-semibold leading-tight truncate">Admin</span>
                    <span class="text-xs leading-tight truncate"
                          style="color: rgb(255 255 255 / 0.4);">Administrator</span>
                </div>
                ...
                <div class="relative" x-data="dropdown">
                    ...
                    <button type="button"
                        ...
                        <div class="hidden sm:flex flex-col items-start leading-tight">
                            <span class="text-xs font-semibold" style="color: #1e293b;">Admin</span>
                            <span class="text-xs" style="color: #94a3b8;">Administrator</span>
                        </div>
                    ...
                    <div class="dropdown-menu right-0 mt-2 w-56"
                        ...
                        <div class="flex items-center gap-3 px-4 py-3 border-b border-slate-100">
                            ...
                            <div class="min-w-0">
                                <p class="text-xs font-semibold truncate" style="color: #1e293b;">Admin</p>
                                <p class="text-xs truncate" style="color: #94a3b8;">admin@miftahululum.sch.id</p>
                            </div>
                        </div>
                        ...
                        <div class="border-t border-slate-100 py-1">
                            @if(Route::has('logout'))
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit" class="dropdown-item danger w-full text-left" role="menuitem">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24"
                                             fill="none" stroke="currentColor" stroke-width="1.5"
                                             stroke-linecap="round" stroke-linejoin="round">
                                            <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/>
                            ...
                            @else
                                <a href="{{ url('/logout') }}" class="dropdown-item danger" role="menuitem">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24"
                                         fill="none" stroke="currentColor" stroke-width="1.5"
                                         stroke-linecap="round" stroke-linejoin="round">
                                        <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/>
