        ...
        <aside class="sidebar" :class="{ 'collapsed': collapsed, 'mobile-open': mobileOpen }"
            ...
            <nav class="sidebar-nav">
                ...
                <a href="{{ route('permissions.index') }}"
                    class="nav-item {{ request()->routeIs('permissions.*') ? 'active' : '' }}" @click="closeMobile()">
                    <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" viewBox="0 0 24 24"
                     fill="none" stroke="currentColor" stroke-width="1.5"
                     stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="sidebar-footer">
                <div class="user-card">
                    ...
                    <button type="button" onclick="openLogoutModal()" class="logout-btn" title="Keluar">
                        ⏻
                    </button>
                </div>
            </div>
        ...
        <div class="main-wrapper" :class="{ 'sidebar-collapsed': collapsed }">
            <header class="topbar">
                ...
                <div class="flex items-center gap-2 ml-auto">
                    <button type="button" class="btn-icon relative">
                        🔔
                        <span class="notif-dot"></span>
                    </button>

                    <button type="button" class="btn-icon" onclick="openLogoutModal()">
                        Keluar
                    </button>
                </div>
            </header>
