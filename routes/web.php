...
Route::get("/students/{id}/edit", [StudentController::class, "edit"])->name(
    "students.edit",
);
...
// Parents
Route::get("/parents", [ParentController::class, "index"])->name(
    "parents.index",
);
Route::get("/parents/create", [ParentController::class, "create"])->name(
    "parents.create",
);
Route::post("/parents", [ParentController::class, "store"])->name(
    "parents.store",
);
Route::get("/parents/{id}/edit", [ParentController::class, "edit"])->name(
    "parents.edit",
);
Route::put("/parents/{id}", [ParentController::class, "update"])->name(
    "parents.update",
);
Route::delete("/parents/{id}", [ParentController::class, "destroy"])->name(
    "parents.destroy",
);
...
Route::get("/attendance/report", [AttendanceController::class, "report"])->name(
    "attendance.report",
);
...
Route::post("/chat/{parentId}", [ChatController::class, "send"])->name(
    "chat.send",
);
...
Route::put("/permissions/{id}", [PermissionController::class, "update"])->name(
    "permissions.update",
);
Route::post("/permissions/{id}/approve", [
    PermissionController::class,
    "approve",
])->name("permissions.approve");
Route::post("/permissions/{id}/reject", [
    PermissionController::class,
    "reject",
